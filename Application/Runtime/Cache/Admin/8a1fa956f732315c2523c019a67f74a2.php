                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="link-update" href="/index.php?m=admin&c=part&a=edit&pid=<?php echo $part['pid'] ?>">修改</a>
                                <a class="link-del" href="/index.php?m=admin&c=part&a=del&pid=<?php echo $part['pid'] ?>">删除</a>
                            </td>
                        </tr>	
                        <?php endforeach; ?>
                    </table>
