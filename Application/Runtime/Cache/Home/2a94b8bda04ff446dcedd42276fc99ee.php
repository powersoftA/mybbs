		...
		<div class="content">		
            ...
            <div class="section">
                ...
                <div class="section_title">
                  <span class="section_title_left"><?php echo ($part["pname"]); ?></span>
                  <span class="section_title_right">分区版主：<a href="">aa</a></span>
                </div>
                <!--分区标题部分end-->
                
                <!--分区内容部分start-->
                <?php foreach($part['sub'] as $cate): ?>
                  ...
                  <table cellspacing="0" celpadding="0">
                    <tr>
                      <td width="33%">
                        ...
                        <dl>
                          <dd class="dd_title"><a href="/index.php?m=home&c=post&a=index&cid=<?php echo $cate['cid'] ?>"><?php echo ($cate["cname"]); ?></a></dd>
                          <dd>
                            <em>主题：54</em>,
                            <em>帖子：244</em>
                          </dd>
