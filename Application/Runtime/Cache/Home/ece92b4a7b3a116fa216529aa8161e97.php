			...
			<div class="post_list" >
				...
				<div class="post_content">
					<table cellspacing=0 cellpadding=0 width='100%'>
						...
						<tr>
							<td class="list_title"><?php echo ($post["title"]); ?></td>
							<td class="list_author"><?php echo $users[$post['uid']] ?></td>
							<td class="list_count">10/20</td>
							<td class="list_ptime"><?php echo date('Y-m-d H:i:s', $post['created_at']) ?></td>
						</tr>
						<?php endforeach; ?>
					</table>
				</div>
